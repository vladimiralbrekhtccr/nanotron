...
--checkpoint_path /scratch/vladimir_albrekht/projects/smollm/output/nanotron_3B_qwen/200 \
--save_path /scratch/vladimir_albrekht/projects/smollm/output/nanotron_3B_qwen/200/hf \
